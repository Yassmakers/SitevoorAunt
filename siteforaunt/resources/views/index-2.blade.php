        ...
        <div class="row">
            ...
            <div class="col-xl-8 col-lg-8 d-none d-lg-block">
                <div class="main-menu">
                    <nav>
                        <ul>
                            <li><a href="index.blade.php">Home <i class="fa fa-angle-down"></i></a>
                                <ul class="submenu">
        ...
        <div class="row">
            <div class="col-lg-4 col-md-4">
                <div class="single-banner mb-30">
                    <a href="product-details.blade.php"><img src="assets/img/banner/banner-1.jpg" alt=""></a>
                    <div class="banner-content">
                        <h3>Watches</h3>
                        <h4>Starting at <span>$99.00</span></h4>
                        <a href="product-details.blade.php"><i class="fa fa-long-arrow-right"></i></a>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-4">
                <div class="single-banner mb-30">
                    <a href="product-details.blade.php"><img src="assets/img/banner/banner-2.jpg" alt=""></a>
                    <div class="banner-content">
                        <h3>Plo Bag</h3>
            ...
            <div class="col-lg-4 col-md-4">
                <div class="single-banner mb-30">
                    <a href="product-details.blade.php"><img src="assets/img/banner/banner-3.jpg" alt=""></a>
                    <div class="banner-content">
                        <h3>Sunglass</h3>
                        <h4>Starting at <span>$79.00</span></h4>
                        <a href="product-details.blade.php"><i class="fa fa-long-arrow-right"></i></a>
                        ...
                        <div class="product-wrap-2 mb-25 scroll-zoom">
                            ...
                            <div class="product-content-2">
                                <div class="title-price-wrap-2">
                                    <h3><a href="product-details.blade.php">T- Shirt And Jeans</a></h3>
                                    <div class="price-2">
                                        <span>$ 60.00</span>
                                ...
                                <div class="pro-wishlist-2">
                                    <a title="Wishlist" href="wishlist.blade.php"><i class="fa fa-heart-o"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
